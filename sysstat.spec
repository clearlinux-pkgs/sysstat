...
Version  : 12.5.2
Release  : 60
URL      : https://github.com/sysstat/sysstat/archive/v12.5.2/sysstat-12.5.2.tar.gz
Source0  : https://github.com/sysstat/sysstat/archive/v12.5.2/sysstat-12.5.2.tar.gz
...
%prep
%setup -q -n sysstat-12.5.2
cd %{_builddir}/sysstat-12.5.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608604555
...
cp %{_builddir}/sysstat-12.5.2/COPYING %{buildroot}/usr/share/package-licenses/sysstat/3127907a7623734f830e8c69ccee03b693bf993e
...
/usr/share/doc/sysstat-12.5.2/CHANGES
/usr/share/doc/sysstat-12.5.2/COPYING
/usr/share/doc/sysstat-12.5.2/CREDITS
/usr/share/doc/sysstat-12.5.2/FAQ.md
/usr/share/doc/sysstat-12.5.2/README.md
/usr/share/doc/sysstat-12.5.2/sysstat-12.5.2.lsm
