...
Version  : 12.7.1
Release  : 70
URL      : https://github.com/sysstat/sysstat/archive/v12.7.1/sysstat-12.7.1.tar.gz
Source0  : https://github.com/sysstat/sysstat/archive/v12.7.1/sysstat-12.7.1.tar.gz
...
%prep
%setup -q -n sysstat-12.7.1
cd %{_builddir}/sysstat-12.7.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667864670
