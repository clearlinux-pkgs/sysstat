...
%prep
%setup -q -n sysstat-12.5.4
cd %{_builddir}/sysstat-12.5.4
%patch1 -p1
...
cp %{_builddir}/sysstat-12.5.4/contrib/irqstat/LICENSE %{buildroot}/usr/share/package-licenses/sysstat/eb93c122a87516d45e194a88122b874a019cf0f8
