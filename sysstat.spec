...
Version  : 12.7.7
Release  : 75
URL      : https://github.com/sysstat/sysstat/archive/v12.7.7/sysstat-12.7.7.tar.gz
Source0  : https://github.com/sysstat/sysstat/archive/v12.7.7/sysstat-12.7.7.tar.gz
...
%prep
%setup -q -n sysstat-12.7.7
cd %{_builddir}/sysstat-12.7.7
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746135401
